...
public class RolodexCookieFilterRegistrationBean extends FilterRegistrationBean {
    ...
    public RolodexCookieFilterRegistrationBean(RemoteIdmService remoteIdmService, FlowableCommonAppProperties properties) {
    ...
    protected void initializeFilter() {
        if (getFilter() == null) {
            RolodexCookieFilter rolodexCookieFilter = new RolodexCookieFilter(remoteIdmService, properties);
